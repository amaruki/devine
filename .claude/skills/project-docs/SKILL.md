...
| `GLOSSARY.md`                   | What does this _word_ mean here?            | Anyone reading code or specs |
| `DEVELOPMENT_SCENARIO_GUIDE.md` | How do I actually _do_ a task end-to-end?   | A developer picking up work  |
...
- **Run/build truth:** README, `CONTRIBUTING.md`, `CLAUDE.md`/`AGENTS.md`, manifests, lockfiles, scripts, `.env.example`, compose/Dockerfile, CI workflows. Get the _real_ setup and verification commands — don't guess them.
